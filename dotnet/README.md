...
The stable 1.0.2 build includes:
...
`StreamRecorder-1.0.2.zip` and the fixed filename `StreamRecorder.zip`. Use
...
The installer is published in the same way: `StreamRecorder-1.0.2-setup.exe`
